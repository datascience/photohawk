...
public class ScaleToNearestFactorPreprocessor extends ScalePreprocessor {
     ...
     *            image 2
     * @param targetSize
     *            maximum size of the smaller side
     */
    public ScaleToNearestFactorPreprocessor(final BufferedImage img1, final BufferedImage img2, int targetSize) {
        super(img1, img2, calcScaleFactor(img1, targetSize), calcScaleFactor(img1, targetSize), calcScaleFactor(img2,
            targetSize), calcScaleFactor(img2, targetSize));
    }
