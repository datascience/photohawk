 ...
 */
public class PAEActivity extends XAEErrorActivity<CommonActivityConfigurationBean> implements
    ...
    public void executeAsynch(final Map<String, T2Reference> inputs, final AsynchronousActivityCallback callback) {
        callback.requestRun(new Runnable() {
            public void run() {
                ...
                PAEMetric metric = new PAEMetric(new SRGBColorConverter(new ConvenientBufferedImageWrapper(images[0])),
