...
/**
 * Activity configuration bean for Java image evaluator
 */
public class JavaImageEvaluatorActivityConfigurationBean extends MeasurementURIConfigurationBean implements
    Serializable {
