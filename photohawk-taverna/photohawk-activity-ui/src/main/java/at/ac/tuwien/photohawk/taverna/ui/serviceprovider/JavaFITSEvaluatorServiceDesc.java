...
public class JavaFITSEvaluatorServiceDesc extends ServiceDescription<JavaFITSEvaluatorActivityConfigurationBean> {
     ...
     */
    @Override
    public Class<? extends Activity<JavaFITSEvaluatorActivityConfigurationBean>> getActivityClass() {
        return JavaFITSEvaluatorActivity.class;
    }
     ...
     */
    @Override
    public JavaFITSEvaluatorActivityConfigurationBean getActivityConfiguration() {
        JavaFITSEvaluatorActivityConfigurationBean bean = new JavaFITSEvaluatorActivityConfigurationBean();
        List<String> measurementURIs = new ArrayList<String>(1);
        measurementURIs.add("outcome://object/image/dimension/width#equal");
        measurementURIs.add("outcome://object/image/dimension/height#equal");
