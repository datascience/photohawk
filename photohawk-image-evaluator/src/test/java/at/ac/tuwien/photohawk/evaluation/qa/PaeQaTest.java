...
/**
 * Unit tests for PAE QE.
 */
public class PaeQaTest extends AbstractOperationTest {
    ...
    public void evaluateTest_differentWidth() {
        ...
        PaeQa paeQa = new PaeQa();
        TransientOperation<Float, StaticColor> op = paeQa.evaluate(left, right);
    }
    ...
    public void evaluateTest_solid0000FF_solid0099ff() {
        ...
        checkOperationEqual(op, 0.6f, expected);
    }
