...
import at.ac.tuwien.RAWverna.model.model.values.FloatRangeValue;
...
public class FloatRangeScale extends RestrictedScale {
	 ...
	 * @see #p
	 */
	public static final String pattern = floatPattern + Scale.SEPARATOR
			+ floatPattern;
	...
	public String getRestriction() {
		if ((lowerBound == Double.MIN_VALUE)
			...
			return Double.toString(lowerBound) + Scale.SEPARATOR
	...
	protected boolean restrictionIsValid(String leafName,
		...
		if (getRestriction() == null || "".equals(getRestriction())) {
			errors.add(new ValidationError(
					"Please enter a restriction for the scale of type 'Number range' at leaf '"
							+ leafName + "'", this));
			return false;
		}
