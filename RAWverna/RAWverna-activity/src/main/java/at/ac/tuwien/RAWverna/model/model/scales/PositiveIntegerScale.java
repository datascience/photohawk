...
import at.ac.tuwien.RAWverna.model.model.values.PositiveIntegerValue;
...
public class PositiveIntegerScale extends RestrictedScale {
	...
	public boolean isCorrectlySpecified(String leafName,
		...
		if (getUnit() == null || "".equals(getUnit())) {
			errors.add(new ValidationError(
					"Please enter a unit for the scale of type 'Positive Integer' at leaf '"
							+ leafName + "'", this));
			return false;
		}
