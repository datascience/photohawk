...
import at.ac.tuwien.RAWverna.model.model.values.IntRangeValue;
import at.ac.tuwien.RAWverna.model.model.values.Value;
import at.ac.tuwien.RAWverna.model.validation.ValidationError;

/**
 * Integer value within a specified range, to be used in the leaves of the
 * objective tree
 * 
...
// message="Please enter a restriction for the scale of type 'Int Range'.")
public class IntRangeScale extends RestrictedScale {
	 ...
	 * @see #p
	 */
	public static final String pattern = intPattern + Scale.SEPARATOR
			+ intPattern;
	...
	public String getRestriction() {
		if ((lowerBound == Integer.MIN_VALUE)
			...
			return Integer.toString(lowerBound) + Scale.SEPARATOR
	...
	public void setRestriction(String restriction) {
		...
		try {
			...
			Logger.getLogger(getClass()).warn(
					"Ignoring invalid numberformat in setRestriction:"
							+ restriction);
		}
	}
	...
	protected boolean restrictionIsValid(String leafName,
		...
		if (getRestriction() == null || "".equals(getRestriction())) {
			errors.add(new ValidationError(
					"Please enter a restriction for the scale of type 'Int Range' at leaf '"
							+ leafName + "'", this));
			return false;
		}
		...
		if (this.lowerBound >= this.upperBound) {
			errors.add(new ValidationError(
					"The lower bound specified for leaf \"" + leafName
