...
public class RAWvernaActivity extends
		AbstractAsynchronousActivity<RAWvernaActivityConfigurationBean>
		implements AsynchronousActivity<RAWvernaActivityConfigurationBean> {
	...
	@Override
	public void configure(RAWvernaActivityConfigurationBean configBean)
...
//					callback.fail("Could not invoke RAWverna service " + configBean.getExampleUri(),
//							ex);
