package at.ac.tuwien.RAWverna.model.evaluation;
...
import at.ac.tuwien.RAWverna.model.model.scales.BooleanScale;
import at.ac.tuwien.RAWverna.model.model.scales.FloatRangeScale;
...
import at.ac.tuwien.RAWverna.model.model.scales.IntRangeScale;
import at.ac.tuwien.RAWverna.model.model.scales.IntegerScale;
import at.ac.tuwien.RAWverna.model.model.scales.OrdinalScale;
import at.ac.tuwien.RAWverna.model.model.scales.PositiveFloatScale;
import at.ac.tuwien.RAWverna.model.model.scales.PositiveIntegerScale;
import at.ac.tuwien.RAWverna.model.model.scales.YanScale;
...
public class MeasurementsDescriptorParser {
	...
	public void load(InputStream in,
			Map<String, MeasurableProperty> propertyInfo,
			Map<String, Metric> metricInfo) {
		...
		try {
			...
			Logger.getLogger(getClass()).error(
					"could not parse measurement infos", e);
		}
	}

	public void load(Reader in, Map<String, MeasurableProperty> propertyInfo,
			Map<String, Metric> metricInfo) {
		this.propertyInfo = propertyInfo;
		this.metricInfo = metricInfo;
